...
double DS_timer::getTimer_s(UINT id) {
#ifdef _WIN32
	return ((double)totalTicks[id].QuadPart / (double)ticksPerSecond.QuadPart);
#else
	return (double)(totalTicks[id].tv_sec + totalTicks[id].tv_usec / 1000000.0);
#endif
}
